...
import { F as FadeIn } from "./page-home-CD24yRrU.js";
import { aq as Mail, ac as MapPin, C as CircleAlert, ai as MessageSquare, a3 as CircleCheck, ar as Send } from "./vendor-ui-WQAzzLgx.js";

function Contact() {
  // Removed unused state hooks: isSubmitting, isSuccess, and handleSubmit function
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "py-16 md:py-24 bg-white relative", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 md:px-6 lg:px-8 relative z-10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-1 gap-16 items-start", children: [ // Updated grid to single column since one side is removed

        /* @__PURE__ */ jsxRuntimeExports.jsx(FadeIn, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-10 pr-0 lg:pr-10 max-w-3xl mx-auto", children: [ // Centered and constrained width
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl overflow-hidden shadow-lg border border-border h-96 relative hidden md:block", children: [ // Increased height for better visual balance
        ...
        // --- The entire "FadeIn" block for the inquiry form has been deleted here ---
